...
local GA_CROSSOVER_POINTS   = 5    --GA crossover rate
local GA_MUTATION_RATE      = 0.001  --GA mutation rate
...
while candidates[1].has_won == false do
	...
	--ga_crossover
	ga_crossover(candidates, MAX_CANDIDATES, MAX_CONTROLS_PER_CAND);
	--ga_mutate
